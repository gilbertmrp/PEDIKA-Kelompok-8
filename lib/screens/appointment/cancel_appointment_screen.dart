...
class _CancelAppointmentScreenState extends State<CancelAppointmentScreen> {
  ...
  Future<void> _handleCancel() async {
    ...
    try {
      await APIService().cancelAppointment(widget.appointmentId, _cancelJanjiTemu.text);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Pembatalan Janji Temu" ,style:
        TextStyle(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(widget.details, style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w500, color: Colors.grey),),
              ),
