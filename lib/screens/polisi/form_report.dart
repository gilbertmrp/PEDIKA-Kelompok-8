        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(border: OutlineInputBorder(), hintText: 'Ketik judul laporan anda', hintStyle: TextStyle(color: Colors.grey)),
              validator: (value) {
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(border: OutlineInputBorder(), hintText: 'Ketik isi laporan anda', hintStyle: TextStyle(color: Colors.grey)),
              maxLines: 4,
              validator: (value) {
                if(value == null || value.isEmpty) {
              ...
              child: Row(
                children: <Widget>[
                  Padding(
                    ...
                    child: Text(
                      selectedLocation == null ? 'Lokasi masih kosong' : 'Jl. Sitoluama, Laguboti, Toba Samosir, Sumatera Utara',
              ...
              children: <Widget>[
                Expanded(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border.all(color: visibility == "anonim" ? AppColor.primaryColor : Colors.grey),
                    ),
                    child: Row(
                ...
                Expanded(
                  child: Container(
                    padding: const EdgeInsets.all(10),
                    decoration: BoxDecoration(
                      border: Border.all(color: visibility == "publik" ? AppColor.primaryColor : Colors.grey), // Menyesuaikan warna border saat dipilih atau tidak
                    ),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                  ...
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      TextSpan(
                        ...
                        style: TextStyle(
                          color: visibility == 1 ? AppColor.primaryColor : AppColor.primaryColor, // Warna khusus untuk "Anonim" atau "Publik"
                        ),
                      ),
                    ],
                  ),
