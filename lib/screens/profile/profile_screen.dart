...
import 'package:violence_app/maintanance.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (userProvider.isLoggedIn && userProvider.user != null) {
      return Scaffold(
          appBar: AppBar(
            title: Text("Halaman Profil", style:
            TextStyle(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  userProvider.user?.photo_profile != "" || auth.FirebaseAuth.instance.currentUser?.photoURL != null
                                      ? CircleAvatar(
                                    radius: 40,
                                    ...
                                    child: CircleAvatar(
                                      ...
                                      backgroundImage: NetworkImage(
                                        userProvider.user?.photo_profile ?? auth.FirebaseAuth.instance.currentUser!.photoURL!,
                                      ),
                                    ),
                                  )
                                      : const CircleAvatar(
                              ...
                              Text("Email : ${userProvider.user?.email}", style: const TextStyle(
                                fontSize: 13,
                                fontFamily: 'Poppins',
                                fontWeight: FontWeight.bold,
                              ),),
                              const SizedBox(height: 10,),
                              Text("No.Telp : ${userProvider.user?.phone_number}", style: const TextStyle(
                                fontSize: 13,
                                fontFamily: 'Poppins',
                                fontWeight: FontWeight.bold,
                              ),),
                        ...
                        child: Container(
                          ...
                          child: const Row(
                            children: [
                              ...
                              SizedBox(width: 10,),
                              Text('Laporan Anda', style: TextStyle(
                                fontSize: 14,
                                fontFamily: 'Poppins',
                                fontWeight: FontWeight.bold,
                              ),)
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              const SizedBox(width: 10,),
                              const Text('Request Pertemuan', style: TextStyle(
                                fontSize: 14,
                                fontFamily: 'Poppins',
                                fontWeight: FontWeight.bold,
                              ),)
                            ...
                            Row(
                              children: [
                                ...
                                OutlinedButton(
                                  ...
                                  child: Text("Masuk", style: TextStyle(color: AppColor.primaryColor),),
                                ),
                              ],
                            ),
                          ],
                    ...
                    GestureDetector(
                      onTap: () {
                        if (userProvider.isLoggedIn) {
                          ...
                          Navigator.of(context).pushNamed('/login', arguments: {'redirectTo': '/laporan'});
                        }
                      },
                      child: Container(
                        padding: const EdgeInsets.all(10),
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text('Baca syarat & ketentuan', style: TextStyle(
                                  fontSize: 14,
                                  fontFamily: 'Poppins',
                                ),),
                              ],
