import 'package:violence_app/model/report/report_category_model.dart';
import 'package:violence_app/model/report/report_request_model.dart';
import 'package:violence_app/model/report/tracking_report_model.dart';
...
class ReportDetail {
  ...
  factory ReportDetail.fromJson(Map<String, dynamic> json) {
    return ReportDetail(
      ...
      violenceCategory: ViolenceCategory.fromJson(json['ViolenceCategory'] ?? {}),
      kategoriKekerasanId: json['kategori_kekerasan_id'] ?? 0,
      tanggalPelaporan: DateTime.parse(json['tanggal_pelaporan'] ?? DateTime.now().toIso8601String()),
      tanggalKejadian: DateTime.parse(json['tanggal_kejadian'] ?? DateTime.now().toIso8601String()),
      ...
      waktuDilihat: json['waktu_dilihat'] != null ? DateTime.parse(json['waktu_dilihat']) : null,
      useridMelihat: json['userid_melihat'] ?? 0,
      waktuDiproses: json['waktu_diproses'] != null ? DateTime.parse(json['waktu_diproses']) : null,
      waktuDibatalkan: json['waktu_dibatalkan'] != null ? DateTime.parse(json['waktu_dibatalkan']) : null,
      dokumentasi: Dokumentasi.fromJson(json['dokumentasi'] ?? {}),
      createdAt: DateTime.parse(json['created_at'] ?? DateTime.now().toIso8601String()),
      updatedAt: DateTime.parse(json['updated_at'] ?? DateTime.now().toIso8601String()),
      trackingLaporan: json['tracking_laporan'] != null ? (json['tracking_laporan'] as List).map((item) => TrackingLaporanModel.fromJson(item)).toList() : [],
      pelaku: json['pelaku'] != null ? List<dynamic>.from(json['pelaku']) : [],
      korban: json['korban'] != null ? List<dynamic>.from(json['korban']) : [],
      userMelihat: json['user_melihat'] != null ? User.fromJson(json['user_melihat']) : null,
    );
  }
